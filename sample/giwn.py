...
if __name__ == '__main__':
    ...
    if stat == 'B':
        rhol = (1/pole) * numpy.sqrt(1/wmax) * numpy.array([basis.vly(l, pole/wmax) for l in range(Nl)])
        Sl = numpy.sqrt(0.5 * beta * wmax**3) * numpy.array([basis.sl(l) for l in range(Nl)])
    elif stat == 'F':
        rhol = numpy.sqrt(1/wmax) * numpy.array([basis.vly(l, pole/wmax) for l in range(Nl)])
        Sl = numpy.sqrt(0.5 * beta * wmax) * numpy.array([basis.sl(l) for l in range(Nl)])    
    Gl_ref = - Sl * rhol
